...
DRAW_NEURONS = True
WHICH_NEURONS = 'E' # E for enemies, W for wall
...
# PREDATOR TRAINING
PREDATOR_LAYERS_LIST = [PREDATOR_NEURONS*2, 3, 2]
ENERGY_ON_MEAL = 300
PREDATOR_INITIAL_ENERGY = 500
NEURON_MULTIPLIER = lambda x: 0 if x == 0 else 3*x+1
